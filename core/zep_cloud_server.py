...
class ZepCloudMCPServer:
    def __init__(self):
        self.app = FastMCP("Zep Cloud MCP Server")
        self.client = ZepCloudClient()
        self._setup_tools()
    ...
    def _setup_tools(self):
        ...
        def create_user(user_id: str, email: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None) -> str:
            ...
            try:
                result = self.client.create_user(user_id, email, metadata)
        ...
        def search_graph(user_id: str, query: str, limit: int = 10) -> str:
            ...
            try:
                result = self.client.search_graph(user_id, query, limit)
                return json.dumps(result)
            except Exception as e:
        ...
        def add_graph_data(user_id: str, data: str, data_type: str = "text") -> str:
            ...
            try:
                result = self.client.add_graph_data(user_id, data, data_type)
                return json.dumps(result)
            except Exception as e:
